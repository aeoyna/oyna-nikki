...
try {
    ...
    <div id="new-post-modal" style="display:none; position:fixed; top:0; left:0; width:600%; height:100%; background:rgba(0,0,0,0.5); z-index:1000;">
        <div id="modal-content" style="position:relative; background:white; margin:auto; padding:20px; width:90%; top:10%; border-radius:10px;">
            <!-- モーダル内の閉じるボタン -->
    ...
    <!-- モーダル用コンテナ -->
    <div id="modal-container" style="display:none; position:fixed; top:0; left:0; width:600%; height:100%; background:rgba(0,0,0,0.5); z-index:1000;"></div>
