...
try {
    ...
    if (isset($_GET['id']) && is_numeric($_GET['id'])) {
        ...
        if ($post) {
            ?>
            <div class="modal" style="background: white; padding: 20px; margin: 50px auto; width: 800%; max-width: 800px; min-height: 400px; position: relative; box-shadow: 0 4px 8px rgba(0,0,0,0.2); border-radius: 8px;">
